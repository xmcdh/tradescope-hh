...
export const v3EdgeRedesignExperiments = [
  ...
  {
    experimentId: 'v7c-funding-eth-lower-threshold',
    status: 'closed',
    closedReason: 'frequency-too-low',
    closedDate: '2026-05-08',
    note: 'ETH edge confirmed (WR 52%, Exp 0.53R at score=2) but ~0.6 trades/month. Cannot increase frequency without destroying quality. Funding extreme with full confirmation is genuinely rare event.',
    strategyVersion: 'v7c-funding-eth-lower-threshold',
    label: 'Funding rate extreme ETH lower threshold',
    candidateOnly: true,
    signalLogic: {
      strategyType: 'fundingRateExtreme',
      fundingPositiveThreshold: 0.00005,
      fundingNegativeThreshold: -0.00005,
      confirmationWindowCandles: 6,
      confirmBodyRatio: 0.4,
      ema21Period: 21,
      ema55Period: 55,
      ema200Period: 200,
      atrPeriod: 14,
      ...
      entryScore: 2,
      rsiPeriod: 14,
      fundingStrongThreshold: 0.0001,
      volumeMaPeriod: 20,
      volumeStrongRatio: 1.5,
    },
    exitGeometry: {
      mode: 'partial-runner',
      firstTarget: 'tp1',
      finalTarget: 'tp2',
      firstWeight: 0.5,
      moveStopToBreakevenAfterFirstTarget: false,
    },
    approvalScope: 'backtest-only',
    unchangedGates: [...COMMON_UNCHANGED_GATES],
  },
  {
    experimentId: 'v7b-funding-eth-relaxed',
    status: 'closed',
    closedReason: 'frequency-too-low',
    closedDate: '2026-05-08',
    note: 'ETH edge confirmed (WR 52%, Exp 0.53R at score=2) but ~0.6 trades/month. Cannot increase frequency without destroying quality. Funding extreme with full confirmation is genuinely rare event.',
    strategyVersion: 'v7b-funding-eth-relaxed',
    label: 'Funding rate extreme ETH relaxed confirmation',
    candidateOnly: true,
    signalLogic: {
      strategyType: 'fundingRateExtreme',
      fundingPositiveThreshold: 0.0001,
      fundingNegativeThreshold: -0.0001,
      confirmationWindowCandles: 8,
      confirmBodyRatio: 0.3,
      ema21Period: 21,
      ema55Period: 55,
      ema200Period: 200,
      atrPeriod: 14,
  ...
  },
  {
    ...
    closedDate: '2026-05-08',
    note: 'ETH edge confirmed (WR 52%, Exp 0.53R at score=2) but ~0.6 trades/month. Cannot increase frequency without destroying quality. Funding extreme with full confirmation is genuinely rare event.',
    strategyVersion: 'v7-funding-rate-extreme',
    label: 'Funding rate extreme reversal',
    candidateOnly: true,
    signalLogic: {
      strategyType: 'fundingRateExtreme',
      fundingPositiveThreshold: 0.0001,
  ...
  {
    experimentId: 'v5b-rsi-divergence-btc',
    status: 'closed',
    closedReason: 'no-edge',
    closedDate: '2026-05-08',
    note: 'BTC WR 48.84% but Exp capped at 0.22R. SOL/ETH no edge. RSI divergence not viable across crypto pairs at 1h.',
    strategyVersion: 'v5b-rsi-divergence-btc',
    label: 'RSI divergence reversal BTC exit extension',
    candidateOnly: true,
    signalLogic: {
  ...
  {
    experimentId: 'v5-rsi-divergence',
    status: 'closed',
    closedReason: 'no-edge',
    closedDate: '2026-05-08',
    note: 'BTC WR 48.84% but Exp capped at 0.22R. SOL/ETH no edge. RSI divergence not viable across crypto pairs at 1h.',
    strategyVersion: 'v5-rsi-divergence',
  ...
  },
  {
    ...
    status: 'NOT_READY',
    closedAt: '2026-05-07',
    closedReason: 'ema50_slope_filter_blocks_all_signals',
    bestResult: {
      pair: 'all',
      trades: 0,
      note: 'OB return rate 31% below 50% threshold. EMA50 slope filter eliminated all candidates.',
    },
    verdict: 'NOT_PROMOTABLE',
    mainBlocker: 'ema50_slope_too_strict_for_choppy_crypto',
    nextCandidate: 'v3-failed-breakout-long-only',
